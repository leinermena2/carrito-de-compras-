          ...
          <div class="col-md-6">
            <div class="row mb-5">
              <div class="col-md-6 mb-3 mb-md-0">
                <button class="btn btn-primary btn-sm btn-block">Renovar Carrito</button>
              </div>
              <div class="col-md-6">
                <button href="http://localhost/carrito/cart.php"class="btn btn-outline-primary btn-sm btn-block">Continuar comprando</button>
              </div>
            </div>
            <div class="row">
              <div class="col-md-12">
                <label class="text-black h4" for="coupon">Cupon</label>
                <p>Escribe aqui tu codigo promocional si tienes uno.</p>
              </div>
              <div class="col-md-8 mb-3 mb-md-0">
                <input type="text" class="form-control py-3" id="coupon" placeholder="Codigo promocional">
              </div>
              <div class="col-md-4">
              ...
              <div class="col-md-7">
                <div class="row">
                  <div class="col-md-12 text-right border-bottom mb-5">
                    <h3 class="text-black h4 text-uppercase">total en el carro</h3>
                  </div>
                </div>
                <div class="row mb-3">
                  <div class="col-md-6">
